...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, ticketList: [] };
}
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      ticketList: Array.isArray(object?.ticketList) ? object.ticketList.map((e: any) => Ticket.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.ticketList) {
      obj.ticketList = message.ticketList.map((e) => e ? Ticket.toJSON(e) : undefined);
    } else {
      obj.ticketList = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.params = (object.params !== undefined && object.params !== null)
      ...
      : undefined;
    message.ticketList = object.ticketList?.map((e) => Ticket.fromPartial(e)) || [];
    return message;
  },
};
